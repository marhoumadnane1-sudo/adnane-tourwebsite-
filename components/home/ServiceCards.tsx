...
const services = [
  {
    ...
    description: "Meet & greet at arrivals with your name on a sign. We track your flight in real time — if it's delayed, your driver waits.",
  ...
  },
  {
    icon: MapPin,
    title: "City to City",
    description: "Direct private rides from Casablanca to any major city. No shared taxis, no bus stops — straight to your destination.",
  ...
  },
  {
    ...
    description: "Your own private driver for a half day, full day, or multiple days. Explore Morocco at your own pace.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="section-subtitle">
            Whether you&apos;re arriving from the airport, travelling between cities, or
            want a private driver for the day — we have you covered.
          </p>
        </motion.div>
          ...
          {services.map((service) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className={`card p-8 relative overflow-hidden group ${service.featured ? "ring-2 ring-terracotta shadow-glow" : ""}`}
              >
                {service.featured && (
