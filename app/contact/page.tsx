              ...
              <div className="bg-white rounded-2xl shadow-card p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-charcoal/60 uppercase tracking-wider mb-1.5">{t("contact", "formName")}</label>
                      <input
                        required
                        value={form.name}
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-charcoal/60 uppercase tracking-wider mb-1.5">{t("contact", "formEmail")}</label>
                      <input
                        required
                        type="email"
                        value={form.email}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-charcoal/60 uppercase tracking-wider mb-1.5">{t("contact", "phone")}</label>
                      <input
                        value={form.phone}
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-charcoal/60 uppercase tracking-wider mb-1.5">{t("contact", "formMessage")}</label>
                    <textarea
                      required
                      rows={5}
                      value={form.message}
